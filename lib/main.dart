...
import 'package:esewaapp/welcome_page_1.dart';
...
//           productId: "1d71jd812", // Replace with your unique product ID
//           productName: "Product One", // Replace with your product name
//           productPrice: "20",
//           callbackUrl: '', // Replace with the amount you are charging
//         ),
...
//         var transactionDetails = responseData.isNotEmpty
//             ? responseData[0]['transactionDetails']
//             : null;

//         if (transactionDetails != null &&
//             transactionDetails['status'] == 'COMPLETE') {
...
//         // Handle HTTP error
//         debugPrint(
//             "Transaction Verification HTTP Error: ${response.statusCode}");
//         // Example: Show error message or retry payment
//       }
//     } catch (e) {
//       // Handle exceptions
...
//   //   String merchantSecret = "8gBm/:&EnhH.1/q";
